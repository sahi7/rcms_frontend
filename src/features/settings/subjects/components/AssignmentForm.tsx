                    ...
                    <div>
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                ...
                                >
                                    {watchedTeacher
                                        ? refData.teachers.find((t: any) => String(t.id) === watchedTeacher)?.full_name
                                        : "Choose teacher"}
                                ...
                                <Command>
                                    ...
                                    <CommandGroup className="max-h-64 overflow-auto">
                                        {refData.teachers.map((t: any) => (
                                            <CommandItem
                                                key={t.id}
                                                onSelect={() => setValue("teacher", String(t.id), { shouldValidate: true })}
                                            >
                                                <Check
                                                    className={cn(
                                                        "mr-2 h-4 w-4",
                                                        watchedTeacher === String(t.id) ? "opacity-100" : "opacity-0"
                                                    )}
                                                />
                                                {t.full_name}
                                            </CommandItem>
                    ...
                    <div>
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                ...
                                >
                                    {watchedDepartment
                                        ? refData.departments.find((d: any) => String(d.id) === watchedDepartment)?.name
                                        : "Choose department"}
                                    <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                </Button>
                            </PopoverTrigger>
                                ...
                                <Command>
                                    ...
                                    <CommandGroup className="max-h-64 overflow-auto">
                                        {refData.departments.map((d: any) => (
                                            <CommandItem
                                                key={d.id}
                                                onSelect={() => setValue("department", String(d.id), { shouldValidate: true })}
                                            >
                                                <Check
                                                    className={cn(
                                                        "mr-2 h-4 w-4",
                                                        watchedDepartment === String(d.id) ? "opacity-100" : "opacity-0"
                                                    )}
                                                />
                                                {d.name}
                                            </CommandItem>
