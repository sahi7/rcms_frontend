        ...
        {currentBatch ? (
          <MarksGrid
            ...
            onSave={async (updates) => {
              await saveBatch({ groupKey: currentBatch.batch.group_key, updates });
            }}
          ...
          <>
            ...
            <MarksTable
              ...
              onOpenGrid={async (batch) => {
                const res = await api.get(`/marks/batch-det/${batch.group_key}/`);
                setCurrentBatch(res.data as any); // safe — matches BatchDetail
              }}
            />
          </>
        )}
